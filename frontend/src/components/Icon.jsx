...
export const ArrowIcon = () => (
  ...
  >
    <rect width="44" height="42" fill="#AAAAAA33" rx="8"></rect>
    <path
      stroke="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth="1.5"
      d="m24.25 11.25 5.25 5.25-5.25 5.25m4.447-5.25H14.5m5.25 14.25L14.5 25.5l5.25-5.25m-4.406 5.25H29.5"
    ></path>
  </svg>
);
...
export const MobileArrowIcon = () => (
  ...
  >
    <path
      id="Path_734"
      data-name="Path 734"
      d="M30.728,5.272A18,18,0,0,0,5.272,30.728,18,18,0,0,0,30.728,5.272Zm-18.673,22.3L6.068,21.538l1.5-1.485,3.385,3.413V9.929H13.06V23.523l3.378-3.464,1.51,1.473ZM28.428,15.941,25.05,12.477V26.071H22.94V12.534l-3.385,3.413-1.5-1.485,5.987-6.037,5.893,6.043Z"
